...
This repository showcases my completed courses and certifications, demonstrating my skills and learning journey in Python programming, Generative AI, Responsible AI, and Large Language Models.
...
- **Responsible AI:** Ethical AI usage, fairness, transparency, privacy, and best practices.  
- **Large Language Models (LLMs):** Understanding model capabilities, prompt design, and real-world applications.
...
| Python Programming | STEAM UP | N/A |
| Google Gemini AI Certified Student | Google | [View Certificate](https://cdn.qwiklabs.com/VF6eQ1bV8SfqKBpu8AVD%2F4G93sg9wJQ0wWe9CTc%2FJ%2F4%3D) |
...
## 📌 How to Use
Each folder or link contains the respective certificate or project files. This repository is meant to **showcase my skills, learning progress, and professional development** in programming and AI.
